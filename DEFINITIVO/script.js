...
// Función que se ejecuta cuando se desplaza la ventana
window.onscroll = function() {
  // Comprueba si el desplazamiento vertical de la página es mayor que 20 píxeles
  if (document.documentElement.scrollTop > 20) {
    // Agrega la clase "sticky" al elemento 'nav'
    nav.classList.add("sticky");
    // Muestra el enlace "scrollBtn"
    scrollBtn.style.display = "block";
  } else {
    // Elimina la clase "sticky" del elemento 'nav'
    nav.classList.remove("sticky");
    // Oculta el enlace "scrollBtn"
